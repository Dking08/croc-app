...
class QrCodeParserTest {
    ...
    @Test
    fun parseCode_crocAppGithubIoUrl_extractsCode() {
        assertEquals("1234-test", QrCodeParser.parseCode("https://croc-app.github.io/receive?code=1234-test"))
        assertEquals("7742-code-name", QrCodeParser.parseCode("https://croc-app.github.io/?code=7742-code-name"))
    }
    ...
    fun parseCode_httpUrlAndNoProtocol_extractsCode() {
        ...
        assertEquals("1234-test", QrCodeParser.parseCode("croc-app.github.io/receive?code=1234-test"))
    }

    @Test
    fun parseCode_multipleQueryParams_extractsCode() {
        assertEquals("my-code", QrCodeParser.parseCode("https://croc-app.github.io/receive?foo=bar&code=my-code&baz=123"))
    ...
    fun parseCode_urlEncodedCode_decodesAndNormalizes() {
        assertEquals("my-secret-code", QrCodeParser.parseCode("https://croc-app.github.io/receive?code=my%20secret%20code"))
    ...
    fun parseCode_caseInsensitiveCodeParam_extractsCode() {
        assertEquals("TEST-CODE", QrCodeParser.parseCode("https://croc-app.github.io/receive?CODE=TEST-CODE"))
        assertEquals("TEST-CODE", QrCodeParser.parseCode("croc://receive?CODE=TEST-CODE"))
    }

    @Test
    fun receiveDeepLink_formatsCorrectly() {
        assertEquals("https://croc-app.github.io/receive?code=1234-test", QrCodeParser.receiveDeepLink("1234-test"))
    }
}
