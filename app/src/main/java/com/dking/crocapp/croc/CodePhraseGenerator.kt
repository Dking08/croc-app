...
/**
 * High-entropy cryptographic code phrase generator for croc transfers.
 * Uses the official EFF Short Wordlist #1 (1,296 distinct short words, 3–5 chars).
 *
 * Generating 3 random words produces 1,296^3 = 2,176,782,336 possible combinations
 * (~31.0 bits of entropy), perfectly matching croc v11's standard three-word format.
 */
object CodePhraseGenerator {
    ...
    /**
     * Generates a cryptographically random 3-word code phrase.
     * Example: "acid-barn-zoom"
     */
